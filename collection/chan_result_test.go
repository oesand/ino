...
func TestWaitBufferedSuccess(t *testing.T) {
	ch := make(collection.ChanRes[int], 3)
...
func TestWaitPropagatesError(t *testing.T) {
	ch := make(collection.ChanRes[int], 2)
...
func TestIteratorBuffered(t *testing.T) {
	ch := make(collection.ChanRes[string], 2)
...
func TestIteratorUnbuffered(t *testing.T) {
	ch := make(collection.ChanRes[int])
...
func TestGoHelper(t *testing.T) {
	ch := make(collection.ChanRes[int], 1) // buffered channel
...
func TestUnbuffered(t *testing.T) {
	...
	ch2 := make(collection.ChanRes[int], 5)
	if ch2.UnBuffered() {
...
func TestCloseEarly(t *testing.T) {
	ch := make(collection.ChanRes[int], 5)
