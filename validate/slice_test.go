...
func TestMinCountWithMessage(t *testing.T) {
	v := validate.MinCount[string](2, validate.WithMessage("new message"))
...
func TestMaxCountWithMessage(t *testing.T) {
	v := validate.MaxCount[string](2, validate.WithMessage("new message"))
